...
@section('title', 'Admin - Edit Subcategory')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form action="{{ route('subcategory.update', $subcategory->id) }}" role="form" id="quickForm" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
