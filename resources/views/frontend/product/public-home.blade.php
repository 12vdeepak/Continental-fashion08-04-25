        ...
        <section id="benifits_of_purchasing" class="flex flex-col gap-10 px-4 lg:px-[120px] my-[80px]">
            ...
            <div class="flex flex-col justify-between gap-5 image_gallery">
                <div class="flex justify-between w-full gap-5 sectionSecond">
                    <div
                        ...
                        <img src="{{ asset('frontend/assets/images/Stock item available immediately_small text.png') }}"
                            alt="High Stock Availability" class="absolute inset-0 object-cover w-full h-full rounded-3xl">
                    ...
                    <div
                        ...
                        <img src="{{ asset('frontend/assets/images/Conception & Design_Small text.png') }}"
                            alt="Fast & Secure Delivery" class="absolute inset-0 object-cover w-full h-full rounded-3xl">
                        <div class="titleHighStock mb-5 text-[#FFFFFF] text-lg font-bold text-center lg:text-[32px] z-2">
                        </div>
                    </div>
                </div>
                <div class="flex justify-between w-full gap-5 sectionSecond">
                    <div
                        class="relative lg:h-[320px] h-[20vh] w-1/2 rounded-3xl flex justify-center items-center items-end">
                        <img src="{{ asset('frontend/assets/images/Warehouse.png') }}" alt="Affordable Prices"
